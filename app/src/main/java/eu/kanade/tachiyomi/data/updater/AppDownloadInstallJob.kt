    ...
    private suspend fun startInstalling(
        ...
        try {
            ...
            withContext(Dispatchers.IO) {
                ...
                // Use a shorter timeout to fall back to manual install faster.
                val timeoutDelay = if (DeviceUtil.isHyperOS) 3000L else 5000L
                GlobalScope.launchUI {
                    ...
                    // If the package manager crashes for whatever reason (china phone / HyperOS)
