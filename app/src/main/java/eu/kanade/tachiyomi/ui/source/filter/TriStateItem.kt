...
open class TriStateItem(
    val filter: Filter.TriState,
) : AbstractFlexibleItem<TriStateItem.Holder>() {
    override fun getLayoutRes(): Int = TR.layout.navigation_view_tristatebox

    override fun getItemViewType(): Int = 103
