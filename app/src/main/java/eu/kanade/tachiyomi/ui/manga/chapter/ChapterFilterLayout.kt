...
class ChapterFilterLayout
    ...
    constructor(
        ...
        private fun checkedFilter(
            checkBox: TriStateCheckBox,
            state: TriStateCheckBox.State,
        ) {
        ...
        fun setCheckboxes(
            ...
            binding.showUnread.state =
                when (manga.readFilter(preferences)) {
            ...
            binding.showDownload.state =
                when (manga.downloadedFilter(preferences)) {
            ...
            binding.showBookmark.state =
                when (manga.bookmarkedFilter(preferences)) {
