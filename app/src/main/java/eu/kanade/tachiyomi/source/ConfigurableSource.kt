...
interface ConfigurableSource : Source {
    ...
    fun getSourcePreferences(): SharedPreferences =
        SanitizedSharedPreferences(Injekt.get<Application>().getSharedPreferences(preferenceKey(), Context.MODE_PRIVATE))
...
fun sourcePreferences(key: String): SharedPreferences =
    SanitizedSharedPreferences(Injekt.get<Application>().getSharedPreferences(key, Context.MODE_PRIVATE))
